...
function ChatHeader({ profileImg, profileName, status, statusBubble }) {
	return (
		<div className="headerContainer">
			<div className="headerContainer__profileContainer">
				...
				<div className="headerContainer__profileContainer__nameStatusContainer">
					<h2 className="headerContainer__profileContainer__nameStatusContainer__chatTitle">
						{profileName}
					</h2>
					<div className="headerContainer__profileContainer__nameStatusContainer__chatStatusContainer">
						<div
							className="headerContainer__profileContainer__nameStatusContainer__chatStatusContaine__statusDot"
							style={{ backgroundColor: statusBubble }}
						></div>
						<p className="headerContainer__profileContainer__nameStatusContainer__chatStatusContaine__status">
							{status}
						</p>
					</div>
				</div>
