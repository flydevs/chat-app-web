...
export const NewConversationModal = ({ showConversationModal, setShowConversationModal }) => {
    return (
        <>
                ...
                <div className="modal__wrapper" >
                    <div className="modal">
                        <div className="modal__header">
                            ...
                            <MdClose onClick={() => setShowConversationModal(prev => !prev)} className="modal__header__close" size={25} />
                        </div>
